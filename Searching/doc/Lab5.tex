...
\abstract{Object detection is implemented using colour. Then, the robot localises in a set environment, searches for the foam object in a sea of wooden blocks, captures, and brings it to a set location in under five minutes.}
