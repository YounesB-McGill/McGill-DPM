...
public class Odometer extends Thread {
	...
	private final float robotWidth     = 16.2f; /* [cm] */
	private final float normaliseWidth = 1f / robotWidth; /* [cm^{-1}] */
	/* 5.6 cm / 2; fixme: get more accurate */
	private final float wheelRadiusL   = 2.78f * fromDegrees; /* [cm][rad]/[deg] */
	private final float wheelRadiusR   = 2.78f * fromDegrees; /* [cm][rad]/[deg] */
